...
void Application::Update()
{
	...
	XMStoreFloat4x4(&_world, XMMatrixRotationX(-t) *XMMatrixRotationY(-t)*XMMatrixRotationZ(-t) * XMMatrixTranslation(2.0f, 0.0f, 0.0f));
	XMStoreFloat4x4(&_world2,XMMatrixRotationY(t) * XMMatrixRotationZ(t) * XMMatrixTranslation(-2.0f, 0.0f, 0.0f));
